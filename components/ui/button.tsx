...
const buttonVariants = cva(
  "font-heading inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-md font-heading transition-all duration-500 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] hover:no-underline",
  {
    variants: {
      variant: {
        default:
