...
feature: false
draft: true
title: "Building Hong Kong's First Water Dispenser Map (Modular MDX Example)"
subtitle: "Water For Free"
description: "User-centered revamp to be more helpful and engaged, with modular case-study blocks."
cover: "/static/WaterForFree-Cover-v3.png"
photo: "/static/WaterForFree-Detail.png"
date: "2017-07-01"
path: "water-for-free-modular-example"
...
<SectionTitle
  ...
  subtitle="These three blocks demonstrate the modular pattern for section titles, testimonial callouts, and side-by-side lightbox images."
>
  Sample Modular Components
</SectionTitle>

<TestimonialBox
  author="Rachel Pang"
  role="Co-founder"
  company="Water For Free"
  backgroundColor="#00BFF3"
  textColor="#FFFFFF"
  quote="The redesign helped us turn passive usage into active community contributions. We started receiving substantially more dispenser updates from people on the ground."
/>

<LightboxImagePair
  left={{
    src: "/static/W4F3.png",
    alt: "Water For Free mobile app mockup",
    label: "Mobile Experience",
    caption: "Users can quickly find nearby dispensers and submit updates in-app.",
  }}
  right={{
    src: "/static/W4F-Web.png",
    alt: "Water For Free web admin interface",
    label: "Admin Experience",
    caption: "Volunteers can review and approve edits with an approval workflow.",
  }}
  gap={4}
/>
...
Users can now also suggest edits, updates, upload photos of any water dispensers easily by themselves. By delivering a Wordpress-based content management system in sync for website and app, reported dispensers can be easily approved by volunteer in one click.
