...
Few months later, I revisited the project as I got another idea. The second version tackled a different problem: keeping token prices current across a design without manual updates.
...
Works across every Figma surface that supports plugins: Figma desktop, FigJam, Figma Slides, and Buzz. Whether you're designing, workshopping, or building a deck, it runs wherever you need it.
### Lessons
