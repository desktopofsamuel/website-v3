...
It's free, no paywall. If it saves you time in a project, consider [sponsoring a coffee](https://github.com/desktopofsamuel/web3-design-pal).

Next up, crypto icons! Also, there are left over issues from showing 24h change, as it would usually connected to different color or even different component state. I f you hit a bug or have an idea, ping me on [X](x.com/desktopofsamuel) or [Github](https://github.com/desktopofsamuel/web3-design-pal)!
