...
![](../../public/static/20251104-raycast-1.png)
...
![](../../public/static/20251104-raycast-2.png)
...
![](../../public/static/20251104-raycast-3.png)
## Use Raycast to quickly search Tailwind Classes and Font Awesome Glyph
➡️ Tailwind Extension Link: 
➡️ FA Extension Link: 

Speaking of front-end development resources, two of the documentation sites I often reference and integrated with Raycast are Tailwind CSS and Font Awesome. For Tailwind, You can easily reference class definition, or  refer to class name from Tailwind as well as copying ![](../../public/static/20251104-raycast-4.png)


## Use Raycast as Figma Bookmark & Quick Launcher

## Interested? Use my referral link and install Raycast
Raycast is a Mac app, even though Windows are in active development. iOS app offer some of the functionality but not all. Raycast  is not supported on Android. 