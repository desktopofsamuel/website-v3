...
Raycast is incredibly handy for color conversion. It recognizes major formats—you can simply paste in a color, and it will display a preview. By pressing “Enter” (“Copy color as”), you can choose from different color spaces such as HEX, RGBA, HSL, UIColor, and more. It even supports OKLCH (see [my previous article](/oklch-explained-for-designers) on introducing OKLCH).  
...
![Quick search Tailwind Classes and Font Awesome Glyph](/static/20251104-raycast-4.png)
