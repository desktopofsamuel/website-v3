            ...
            >
              <div className="relative w-full aspect-[1.5/1] bg-muted">
                <Image
                  ...
                  priority
                />
                <span className="absolute bottom-0 left-0 w-full px-4 py-3 bg-gradient-to-t from-black/70 to-transparent text-white font-heading text-2xl" style={{ borderBottomLeftRadius: "var(--radius-lg)", borderBottomRightRadius: "var(--radius-lg)" }}>
                  {post.title}
                </span>
              </div>
            </Link>
